...
const AddAdvPageProduct = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const { data } = await axios.put(
          "https://ej-backend.onrender.com/api/v1/frontProduct/addAdvProduct",
          formData,
          {
            headers: {
    ...
    return (
      ...
      <h1>Create An Advertisement Product</h1>
      </div>
        <div className="form">
          <div className="card">
...
export default AddAdvPageProduct;
